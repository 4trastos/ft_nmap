...
SRC = src/main.c src/args/parse_args.c src/help/show_help.c src/args/parse_ports.c src/args/parse_ip.c src/args/parse_scan_types.c \
	...
	src/output/formatter.c src/output/print_results.c src/utils/time.c src/utils/service_lookup.c src/utils/string_utils.c 
