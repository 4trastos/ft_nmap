...
SRC = src/main.c src/args/parser_args.c src/help/show_help.c src/args/parse_ports.c src/args/parse_ip.c src/args/parse_scan_types.c \
	src/args/parse_speedup.c src/data/ports.c src/data/results.c src/scans/scan_syn.c src/threads/threads.c src/threads/sequential_scan.c \
	...
	src/network/receive_response.c src/network/socket_setup.c src/threads/multi_thread.c src/utils/ft_atoi.c src/data/scan_ports.c\
